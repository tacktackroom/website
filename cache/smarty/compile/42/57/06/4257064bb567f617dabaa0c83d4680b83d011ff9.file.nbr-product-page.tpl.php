<?php /* Smarty version Smarty-3.1.19, created on 2020-02-20 16:00:19
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/ttr/themes/ayon/nbr-product-page.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1850851585e4f1d93a4d730-89249211%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4257064bb567f617dabaa0c83d4680b83d011ff9' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/ttr/themes/ayon/nbr-product-page.tpl',
      1 => 1556103005,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1850851585e4f1d93a4d730-89249211',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4f1d93a79f75_61388357',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4f1d93a79f75_61388357')) {function content_5e4f1d93a79f75_61388357($_smarty_tpl) {?>
<?php if (isset($_smarty_tpl->tpl_vars['p']->value)&&$_smarty_tpl->tpl_vars['p']->value) {?>
	...
	<?php } elseif (isset($_GET['mp_shop_name'])&&$_GET['mp_shop_name']) {?>
		<?php $_smarty_tpl->tpl_vars['requestPage'] = new Smarty_variable($_smarty_tpl->tpl_vars['link']->value->getPaginationLink('supplier',$_smarty_tpl->tpl_vars['supplier']->value,false,false,true,false), null, 0);?>
		<?php $_smarty_tpl->tpl_vars['requestNb'] = new Smarty_variable($_smarty_tpl->tpl_vars['link']->value->getPaginationLink('supplier',$_smarty_tpl->tpl_vars['supplier']->value,true,false,false,true), null, 0);?>
	<?php } else { ?>
	...
	<?php if ($_smarty_tpl->tpl_vars['nb_products']->value>$_smarty_tpl->tpl_vars['products_per_page']->value) {?>
		<?php if (isset($_smarty_tpl->tpl_vars['seller_shop']->value)&&$_smarty_tpl->tpl_vars['seller_shop']->value) {?>
			<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getModuleLink('marketplace','shopstore',array('mp_shop_name'=>$_GET['mp_shop_name']));?>
