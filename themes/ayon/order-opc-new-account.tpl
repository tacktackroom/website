<div id="opc_new_account" class="opc-main-block {if isset($roythemes.nc_guest_only) && $roythemes.nc_guest_only == "1"}guest_only{/if} {if isset($roythemes.nc_guest_add) && $roythemes.nc_guest_add == "1"}guest_add{/if} {if isset($roythemes.nc_opc_width) && $roythemes.nc_opc_width == "1"}opc_cont{/if}" {if isset($roythemes.nc_guest_show)}data-guest-show="{$roythemes.nc_guest_show}"{/if} {if isset($roythemes.nc_guest_text)}data-guest-text="{$roythemes.nc_guest_text}"{/if} {if isset($roythemes.nc_guest_zip)}data-guest-zip="{$roythemes.nc_guest_zip}"{/if}>
...
<div class="left_column_cont">
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
		<fieldset>
			<p><a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="openLoginFormBlock"> {l s='Already registered? Click here for Sign In'}</a></p>
		...
		<fieldset>
        	<div class="box">        	
                <div id="opc_account_choice" class="row">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive guest" id="opc_guestCheckout"><span class="ov_span"><i class="ion-android-checkmark-circle left"></i><span>{l s='Fast Order as Guest'}</span></span></button>
                        </p>

                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive create" id="opc_createAccount"><span class="ov_span"><i class="icon-user left"></i><span>{l s='Create an account'}</span></span></button>
                        </p>   

                        <p class="title_block acc_text">{l s='Create your account today and enjoy:'}</p>
                        <ul class="bullet">
				...
				<div class="required text form-group mail_main">
				...
				<div class="required form-group half half_left first_name_main">
					<label for="firstname">{if isset($roythemes.nc_guest_show) && $roythemes.nc_guest_show == "2"}{l s='Name'}{else}{l s='First name'}{/if} <sup>*</sup></label>
				...
				{if isset($roythemes.nc_guest_show) && ($roythemes.nc_guest_show == "1" ||$roythemes.nc_guest_show == "3")}
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group half half_right first_mob">
				...
				<div class="required form-group half half_right last_name_main">
					<label for="lastname">{l s='Last name'} <sup>*</sup></label>
					<input type="text" class="form-control validate guest_lastname" id="customer_lastname" name="customer_lastname" onblur="$('#lastname').val($(this).val());" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.customer_lastname) && $guestInformations.customer_lastname}{$guestInformations.customer_lastname}{/if}" />
				</div>
				<div class="select form-group date-select {if isset($roythemes.nc_opc_date) && $roythemes.nc_opc_date == "2"}unvis{/if}">
				...
				{if isset($roythemes.nc_guest_add) && $roythemes.nc_guest_add == "1"}
					<h3 class="page-subheading guest_add_opt">{l s='Add delivery address?'}</h3>
					<div class="clearfix"></div>
				{/if}				
			<div class="add_cont">
				<h3 class="page-subheading top-indent new_title">{l s='Delivery address'}</h3>
				{$stateExist = false}
				{$postCodeExist = false}
				{$dniExist = false}
				...
				<div class="required text form-group half half_left unvis">
				...
				<div class="required text form-group half half_right unvis">
					<label for="lastname">{l s='Last name'} <sup>*</sup></label>
					<input type="text" class="text form-control validate guest_lastname" id="lastname" name="lastname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.lastname) && $guestInformations.lastname}{$guestInformations.lastname}{/if}" />
				</div>
				{elseif $field_name eq "address1"}
				<div class="required text form-group">
					<label for="address1">{l s='Address'} <sup>*</sup></label>
					<input type="text" class="text form-control validate guest_replace" name="address1" id="address1" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address1) && isset($guestInformations) && isset($guestInformations.address1) && $guestInformations.address1}{$guestInformations.address1}{/if}" />
				</div>
				{elseif $field_name eq "address2"}
				<div class="text is_customer_param form-group address2_sw">
				...
				<div class="required text form-group {if isset($roythemes.nc_opc_halfcity) && $roythemes.nc_opc_halfcity == "1"}half half_left{/if}">
					<label for="city">{l s='City'} <sup>*</sup></label>
					<input type="text" class="text form-control validate guest_replace" name="city" id="city" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}" />
				</div>
				{elseif $field_name eq "postcode"}
				{$postCodeExist = true}
				<div class="required postcode text form-group {if isset($roythemes.nc_opc_halfcity) && $roythemes.nc_opc_halfcity == "1"}half half_right{/if}">
					<label for="postcode">{l s='Zip/Postal code'} <sup>*</sup></label>
					<input type="text" class="text form-control validate guest_replace_number" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
				</div>
				{elseif $field_name eq "country" || $field_name eq "Country:name"}
				<div class="required select form-group country_sw">
				...
				{/if}				
				{if !$stateExist}
				<div class="required id_state form-group unvisible {if isset($roythemes.nc_opc_halfstate) && $roythemes.nc_opc_halfstate == "1"}half half_left{/if}">
					<label for="id_state">{l s='State'} <sup>*</sup></label>
					<select name="id_state" id="id_state" class="form-control">
						<option value="">-</option>
					</select>
				...
				{/if}
				{if !$dniExist}
				<div class="required dni form-group {if isset($roythemes.nc_opc_halfstate) && $roythemes.nc_opc_halfstate == "1"}half half_right{/if}">
					<label for="dni">{l s='Identification number'} <sup>*</sup></label>
					<input type="text" class="text form-control validate guest_replace_number" name="dni" id="dni" data-validate="isDniLite" value="{if isset($guestInformations) && isset($guestInformations.dni) && $guestInformations.dni}{$guestInformations.dni}{/if}" />
				</div>
				{/if}
				<div class="form-group is_customer_param info_sw">
					<label for="other">{l s='Additional information'}</label>
					<textarea class="form-control" name="other" id="other" cols="26" rows="7"></textarea>
				</div>
				{if isset($one_phone_at_least) && $one_phone_at_least}
					<p class="inline-infos required is_customer_param guest_replace_number">{l s='You must register at least one phone number.'}</p>
				{/if}	

				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group mob_sw mob_hide">
					<label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
					<input type="text" class="text form-control validate" name="phone_mobile" id="phone_mobile" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_mobile) && $guestInformations.phone_mobile}{$guestInformations.phone_mobile}{/if}" />
				</div>
				...
				<div class="checkbox inv_sw" style="margin-top:22px;">
				...
				<div id="opc_invoice_address" class="is_customer_param">
					...
					<h3 class="page-subheading top-indent new_title">{l s='Invoice address'}</h3>
					...
					{elseif $field_name eq "firstname"}
					<div class="required form-group half half_left">
					...
					{elseif $field_name eq "lastname"}
					<div class="required form-group half half_right">
						<label for="lastname_invoice">{l s='Last name'} <sup>*</sup></label>
						<input type="text" class="form-control validate guest_lastname" id="lastname_invoice" name="lastname_invoice" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.lastname_invoice) && $guestInformations.lastname_invoice}{$guestInformations.lastname_invoice}{/if}" />
					</div>
					{elseif $field_name eq "address1"}
					<div class="required form-group">
						<label for="address1_invoice">{l s='Address'} <sup>*</sup></label>
						<input type="text" class="form-control validate guest_replace" name="address1_invoice" id="address1_invoice" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address1_invoice) && isset($guestInformations) && isset($guestInformations.address1_invoice) && $guestInformations.address1_invoice}{$guestInformations.address1_invoice}{/if}" />
					</div>
					{elseif $field_name eq "address2"}
					<div class="form-group is_customer_param info_sw">
					...
					<div class="required postcode_invoice form-group">
						...
						<input type="text" class="form-control validate guest_replace_number" name="postcode_invoice" id="postcode_invoice" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode_invoice) && $guestInformations.postcode_invoice}{$guestInformations.postcode_invoice}{/if}" onkeyup="$('#postcode_invoice').val($('#postcode_invoice').val().toUpperCase());" />
					</div>
					{elseif $field_name eq "city"}
					<div class="required form-group">
						<label for="city_invoice">{l s='City'} <sup>*</sup></label>
						<input type="text" class="form-control validate guest_replace" name="city_invoice" id="city_invoice" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city_invoice) && $guestInformations.city_invoice}{$guestInformations.city_invoice}{/if}" />
					</div>
					{elseif $field_name eq "country" || $field_name eq "Country:name"}
					<div class="required form-group country_sw">
					...
					<div class="required postcode_invoice form-group unvisible">
						<label for="postcode_invoice">{l s='Zip/Postal Code'} <sup>*</sup></label>
						<input type="text" class="form-control validate guest_replace_number" name="postcode_invoice" id="postcode_invoice" data-validate="isPostCode" value="" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
					</div>
					{/if}					
					{if !$stateExist}
					...
					<div class="required form-group dni_invoice">
						<label for="dni">{l s='Identification number'} <sup>*</sup></label>
						<input type="text" class="text form-control validate guest_replace_number" name="dni_invoice" id="dni_invoice" data-validate="isDniLite" value="{if isset($guestInformations) && isset($guestInformations.dni_invoice) && $guestInformations.dni_invoice}{$guestInformations.dni_invoice}{/if}" />
						<span class="form_info">{l s='DNI / NIF / NIE'}</span>
					</div>
					{/if}
					<div class="form-group is_customer_param info_sw">
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group mob_sw">
