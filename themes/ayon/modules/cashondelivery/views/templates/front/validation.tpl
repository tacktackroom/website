...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)|escape:'html'}" method="post">
    ...
    <p class="cart_navigation" id="cart_navigation">
        ...
        <button type="submit" class="button btn btn-default button-medium"><span><i class="ion-android-checkmark-circle left"></i>{l s='I confirm my order' mod='cashondelivery'}</span></button>
    </p>
</form>
