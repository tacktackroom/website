...
<div id="stores_block_left" class="block">
	<h4 class="title_block">
		<a href="{$link->getPageLink('stores')|escape:'html'}" title="{l s='Our stores' mod='blockstore'}">
	...
	<div class="block_content blockstore">
        ...
        {/if}
		<p>
			<a class="btn btn-default button button-small" href="{$link->getPageLink('stores')|escape:'html'}" title="{l s='Our store(s)!' mod='blockstore'}">
