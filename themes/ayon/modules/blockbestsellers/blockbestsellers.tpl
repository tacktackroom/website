...
<div id="best-sellers_block_right" class="block products_block">
	...
	{if $best_sellers && $best_sellers|@count > 0}
		<ul id="topsellersul" class="products-block">
		...
		<div class="lnk" style="text-align: center">
        	<a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='blockbestsellers'}"  class="btn btn-default button button-small"><span><i class="icon-reorder left"></i>{l s='All best sellers' mod='blockbestsellers'}</span></a>
        </div>
	{else}
